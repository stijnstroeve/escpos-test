...
var EscPosCompiler = /** @class */ (function () {
    ...
    EscPosCompiler.prototype.rasterImage = function (rasterImage, options) {
        var data = [];
        data.push.apply(data, this.linefeed(1));
        if ((options === null || options === void 0 ? void 0 : options.alignHT) === 'center') {
            data.push.apply(data, escposCommands_1.EscPos.TXT_ALIGN_CT);
        }
        else if ((options === null || options === void 0 ? void 0 : options.alignHT) === 'right') {
            data.push.apply(data, escposCommands_1.EscPos.TXT_ALIGN_RT);
        }
        else if ((options === null || options === void 0 ? void 0 : options.alignHT) === 'left') {
            data.push.apply(data, escposCommands_1.EscPos.TXT_ALIGN_LT);
        }
        // GSV0 normal header
        data.push(0x1d, 0x76, 0x30, 0x00);
        data.push.apply(data, escposUtils_1.EscPosUtils.uInt16LE(rasterImage.rasterWidth));
        data.push.apply(data, escposUtils_1.EscPosUtils.uInt16LE(rasterImage.height));
        data.push.apply(data, Array.from(rasterImage.data));
        if ((options === null || options === void 0 ? void 0 : options.alignHT) !== undefined) {
            // Reset align
            data.push.apply(data, escposCommands_1.EscPos.TXT_ALIGN_LT);
        }
        return data;
